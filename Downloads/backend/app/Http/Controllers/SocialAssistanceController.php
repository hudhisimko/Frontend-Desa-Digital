...
class SocialAssistanceController extends Controller implements HasMiddleware
{
    ...
    public static function middleware()
    {
        return [
            ...
            new Middleware(PermissionMiddleware::using(['social-aasistance-create']), only: ['store']),
            new Middleware(PermissionMiddleware::using(['social-aasistance-edit']), only: ['update']),
