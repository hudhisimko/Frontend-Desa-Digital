<template>
    ...
    <div
        ...
        <label
            ...
            <img src="@/assets/images/icons/notification-secondary-green.svg"
                class="size-6"
                alt="icon">
            </a>
            <a href="#"
                class="flex size-14 shrink-0 items-center justify-center rounded-2xl border border-desa-background hover:border-desa-secondary transition-setup">
                    <img src="@/assets/images/icons/setting-2-secondary-green.svg"
                        class="size-6"
                        alt="icon">
                    </a>
                <div class="flex items-center gap-4">
                    <div class="flex size-14 shrink-0 rounded-full overflow-hidden bg-desa-foreshadow">
                        <img src="@/assets/images/photos/photo-1.png"
                    ...
                    <img src="@/assets/images/icons/logout-red.svg"
                    class="size-6"
                    alt="logout">
                </a>
            </div>
