...
<template>
        <div id="Modal-Delete" class="modal fixed inset-0 h-screen z-40 flex bg-[#808C1ACC]" v-if="show">
            ...
            <div class="flex flex-col p-4 gap-3">
                ...
                <button
                    class="btn-close-modal flex items-center h-14 rounded-2xl py-3 px-8 gap-[10px] border border-desa-background"
                    @click="$emit('close')">
