...
<template>
       <div id="Header" class="flex items-center justify-between">
                            ...
                            <section id="Kepala-Rumah" class="flex flex-col rounded-3xl p-6 gap-6 bg-white">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="badge rounded-full p-3 gap-2 flex w-[100px] justify-center shrink-0 bg-desa-soft-green">
                                        <span class="font-semibold text-xs text-white uppercase">{{ headOfFamily.marital_status }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center w-full gap-3">
                                    ...
                                    <div class="flex flex-col gap-1 w-full">
                                        <p class="font-semibold text-xl leading-[22.5px]">{{ calculateAge(headOfFamily.date_of_birth) }} Tahun</p>
                                        <span class="font-medium text-desa-secondary">
                                            Umur Kepala Rumah
                                        </span>
                                    </div>
                                ...
                                <div class="flex items-center w-full gap-3">
                                    ...
                                    <div class="flex flex-col gap-1 w-full">
                                        <p class="font-semibold text-xl leading-[22.5px]">{{ ucfirst (headOfFamily.gender) }}</p>
                                        <span class="font-medium text-desa-secondary">
                                            Jenis Kelamin
                                        </span>
                                    </div>
                            ...
                            <section id="Anggota-Keluarga" class="flex flex-col rounded-3xl p-6 gap-6 bg-white"
                             v-if="headOfFamily.family_members?.length">
                                ...
                                <div  class="flex flex-col gap-[14px]">
                                    <div class="card flex flex-col rounded-2xl border border-desa-background p-4 gap-6" v-for="(familyMember, index) in headOfFamily.family_members" :key="index">
                                      
                                    </div>
                                        <div class="flex items-center gap-4">
                                            <div class="flex size-[64px] shrink-0 rounded-full overflow-hidden bg-desa-foreshadow">
                                                <img :src="familyMember.profile_picture" class="w-full h-full object-cover" alt="photo">
                                            </div>
                                            <div class="flex flex-col gap-[6px] w-full">
                                                <p class="font-semibold text-xl line-clamp-1">{{ familyMember.user?.name }}</p>
                                                <p class="flex items-center gap-1">
                                                    <img src="@/assets/images/icons/briefcase-secondary-green.svg" class="flex size-[18px] shrink-0" alt="icon">
                                                    <span class="font-medium text-sm text-desa-secondary">{{ familyMember.occupation }}</span>
                                                </p>
                                            </div>
                                            <p class="font-medium leading-5 text-nowrap">{{ calculateAge(familyMember.date_of_birth) }} tahun</p>
                                        </div>
                    ...
                    <div id="Modal-Delete" class="modal fixed inset-0 h-screen z-40 flex bg-[#080C1ACC]"
                    :class="{ hidden: !showModalDelete}">
            <div id="Alert" class="flex flex-col w-[335px] shrink-0 rounded-2xl overflow-hidden bg-white m-auto">
                ...
                <div class="flex flex-col p-4 gap-3">
                    ...
                    <hr class="border-desa-background">
                    <div class="flex items-center gap-3">
                        <button class="btn-close-modal flex items-center h-14 rounded-2xl py-3 px-8 gap-[10px] border border-desa-background hover:bg-desa-black hover:text-white transition-setup" 
