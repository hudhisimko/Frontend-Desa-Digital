...
const handleSubmit = async () => {
  ...
  formData.append("thumbnail", socialAssistance.value.thumbnail);
  formData.append("name", socialAssistance.value.name);
  formData.append("category", socialAssistance.value.category);
  formData.append("amount", parseRupiah(socialAssistance.value.amount));
  formData.append("provider", socialAssistance.value.provider);
  formData.append("description", socialAssistance.value.description);
  formData.append("is_available", socialAssistance.value.is_available ? 1 : 0); 
  formData.append("_method", "PUT"); // kalau update

  await updateSocialAssistance({ id: socialAssistance.value.id, data: formData });
};
                    ...
                    <form @submit.prevent="handleSubmit" id="myForm" class="capitalize">
                        <div class="shrink-0 rounded-3xl p-6 bg-white flex flex-col gap-6 h-fit">
                            ...
                            <div class="flex flex-col gap-3 flex-1 shrink-0">
                                <Input v-model="socialAssistance.name" type="text" placeholder="Ketik Nama Bantuan"
                            ...
                            <section id="Kategori" class="flex items-center justify-between">
                                ...
                                <div class="grid grid-cols-2 flex-1 gap-6 shrink-0">
                                    ...
                                    <label class="group flex w-full items-center h-14 rounded-2xl p-4 ring-[1.5px] ring-desa-background gap-2 has-[:checked]:ring-none has-[:checked]:bg-desa-foreshadow transition-setup">
                                        <input value="cash"v-model="socialAssistance.category" type="radio" name="category" id="" class="flex size-[18px] shrink-0 accent-desa-secondary checked:accent-desa-dark-green transition-setup">
                                        <span class="font-medium leading-5 text-desa-secondary w-full group-has-[:checked]:text-desa-dark-green transition-setup">
                                            Uang Tunai
                                        </span>
                                        <div class="flex size-6 shrink-0">
                                    ...
                                    <label class="group flex w-full items-center h-14 rounded-2xl p-4 ring-[1.5px] ring-desa-background gap-2 has-[:checked]:ring-none has-[:checked]:bg-desa-foreshadow transition-setup">
                                        <input value="subsidized"v-model="socialAssistance.category" type="radio" name="category" id="" class="flex size-[18px] shrink-0 accent-desa-secondary checked:accent-desa-dark-green transition-setup">
                                        <span class="font-medium leading-5 text-desa-secondary w-full group-has-[:checked]:text-desa-dark-green transition-setup">
                                            BBM Subsidi
                                        </span>
                                        <div class="flex size-6 shrink-0">
                                    ...
                                    <label class="group flex w-full items-center h-14 rounded-2xl p-4 ring-[1.5px] ring-desa-background gap-2 has-[:checked]:ring-none has-[:checked]:bg-desa-foreshadow transition-setup">
                                        <input value="health"v-model="socialAssistance.category" type="radio" name="category" id="" class="flex size-[18px] shrink-0 accent-desa-secondary checked:accent-desa-dark-green transition-setup">
                                        <span class="font-medium leading-5 text-desa-secondary w-full group-has-[:checked]:text-desa-dark-green transition-setup">
                                            Kesehatan
                                        </span>
                                        <div class="flex size-6 shrink-0">
                           ...
                           <section id="Nominal-Bantuan" class="flex items-center justify-between">
                            ...
                            <div class="flex flex-col gap-3 flex-1 shrink-0">
                                ...
                                :error-message="error?.amount" :icon="IconDollarSquareSecondaryGreen" :filled-icon="IconDollarSquareBlack" />
                            </div>
                            </section>
                            <hr class="border-desa-background" />
                           <section id="Nama-Pemberi-Bantuan" class="flex items-center justify-between">
                            ...
                            <div class="flex flex-col gap-3 flex-1 shrink-0">
                                ...
                                :error-message="error?.provider" :icon="IconProfileSecondaryGreen" :filled-icon="IconProfileBlack" />
                            </div>
                            </section>
                            <hr class="border-desa-background" />
                            <section id="Deskripsi" class="flex items-center justify-between">
                                ...
                                <div class="flex flex-col gap-3 flex-1 shrink-0">
                                    <textarea v-model="socialAssistance.description"name="" id="" placeholder="Jelaskan lebih detail tentang bantuan" rows="6" class="appearance-none outline-none w-full rounded-2xl ring-[1.5px] ring-desa-background focus:ring-desa-black py-4 px-4 gap-2 font-medium placeholder:text-desa-secondary transition-all duration-300">Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis, ad.
                                    </textarea>
                                </div>
                            </section>
                            <hr class="border-desa-background" />
                            <section id="Ketersediaan" class="flex items-center justify-between">
                                ...
                                <div class="flex flex-1 gap-6 shrink-0">
                                    <label class="group flex w-full items-center h-14 rounded-2xl p-4 ring-[1.5px] ring-desa-background gap-2 has-[:checked]:ring-none has-[:checked]:bg-desa-foreshadow transition-setup">
                                        <input v-model="socialAssistance.is_available" :value="true" type="radio" name="gender" id="" class="flex size-[18px] shrink-0 accent-desa-secondary checked:accent-desa-dark-green transition-setup">
                                        <span class="font-medium leading-5 text-desa-secondary w-full group-has-[:checked]:text-desa-dark-green transition-setup">
                                            Tersedia
                                        </span>
                                        <div class="flex size-6 shrink-0">
                                    ...
                                    <label class="group flex w-full items-center h-14 rounded-2xl p-4 ring-[1.5px] ring-desa-background gap-2 has-[:checked]:ring-none has-[:checked]:bg-desa-foreshadow transition-setup">
                                        <input v-model="socialAssistance.is_available" :value="false" type="radio" name="gender" id="" class="flex size-[18px] shrink-0 accent-desa-secondary checked:accent-desa-dark-green transition-setup">
                                        <span class="font-medium leading-5 text-desa-secondary w-full group-has-[:checked]:text-desa-dark-green transition-setup">
                                            Tidak Tersedia
                                        </span>
                                        <div class="flex size-6 shrink-0">
                           ...
                           <section id="Buttons" class="flex items-center justify-end gap-4">
                            ...
                            <button :disabled="loading" id="submitButton" type="submit"
                                class="py-[18px] rounded-2xl bg-desa-dark-green disabled:bg-desa-grey w-[180px] text-center flex justify-center font-medium text-white">
                                <span v-if="!loading">
                                Update Now
                                </span>
                                <span v-else>
